...
> **Navigation:** [↑ Course Home](../README.md) · ← [Previous Lab](Lab-06-Environmental-Exposure-Analysis.md) · → [Next Lab](Lab-08-Dose-Response-Analysis.md)
> 📚 Related Modules: [Module 5 — Phenotypic and Compositional Assessment](../MARKDOWN/05-Phenotypic-and-Compositional-Assessment.md), [Module 14 — Food and Feed Safety](../MARKDOWN/14-Food-and-Feed-Safety.md) · 📊 Dataset: [Exercise 6 — Composition](../DATA/composition/) · 📝 Assessment: [Data-Interpretation Questions](../ASSESSMENT/Data-Interpretation-Questions.md)
...
*Previous: [Lab 06 — Environmental Exposure Analysis](Lab-06-Environmental-Exposure-Analysis.md) · Next: [Lab 08 — Dose-Response Analysis](Lab-08-Dose-Response-Analysis.md)*
