...
> **Navigation:** [↑ Course Home](../README.md) · ← [Previous Lab](Lab-08-Dose-Response-Analysis.md) · → [Next Lab](Lab-10-Uncertainty-Sensitivity-Analysis.md)
> 📚 Related Modules: [Module 17 — Risk Characterization](../MARKDOWN/17-Risk-Characterization.md), [Module 2 — Hazard, Risk and Exposure](../MARKDOWN/02-Hazard-Risk-and-Exposure.md) · 📊 Dataset: [Exercise 9 — Risk-matrix scores](../DATA/risk-matrix/) · 📝 Assessment: [Case-Based Questions](../ASSESSMENT/Case-Based-Questions.md)
...
*Previous: [Lab 08 — Dose-Response Analysis](Lab-08-Dose-Response-Analysis.md) · Next: [Lab 10 — Uncertainty and Sensitivity Analysis](Lab-10-Uncertainty-Sensitivity-Analysis.md)*
