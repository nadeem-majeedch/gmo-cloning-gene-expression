...
> **Navigation:** [↑ Course Home](../README.md) · ← [Previous Lab](Lab-07-Compositional-Assessment.md) · → [Next Lab](Lab-09-Risk-Ranking-Matrix.md)
> 📚 Related Modules: [Module 15 — Allergenicity and Toxicity Assessment](../MARKDOWN/15-Allergenicity-and-Toxicity-Assessment.md), [Module 8 — Non-Target Organisms](../MARKDOWN/08-Non-Target-Organisms.md) · 📊 Dataset: [Exercise 8 — Dose-response](../DATA/dose-response/) · 📝 Assessment: [Data-Interpretation Questions](../ASSESSMENT/Data-Interpretation-Questions.md)
...
*Previous: [Lab 07 — Compositional Assessment](Lab-07-Compositional-Assessment.md) · Next: [Lab 09 — Risk-Ranking Matrix](Lab-09-Risk-Ranking-Matrix.md)*
