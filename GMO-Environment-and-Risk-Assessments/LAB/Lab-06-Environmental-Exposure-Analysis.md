...
> **Navigation:** [↑ Course Home](../README.md) · ← [Previous Lab](Lab-05-Resistance-Evolution-Simulation.md) · → [Next Lab](Lab-07-Compositional-Assessment.md)
> 📚 Related Module: [Module 13 — Environmental Fate and Exposure](../MARKDOWN/13-Environmental-Fate-and-Exposure.md) · 📊 Dataset: [Exercise 7 — Exposure concentrations](../DATA/exposure/) · 📝 Assessment: [Data-Interpretation Questions](../ASSESSMENT/Data-Interpretation-Questions.md)
...
*Previous: [Lab 05 — Resistance Evolution Simulation](Lab-05-Resistance-Evolution-Simulation.md) · Next: [Lab 07 — Compositional Assessment](Lab-07-Compositional-Assessment.md)*
