...
> **Navigation:** [↑ Course Home](../README.md) · ← [Previous Lab](Lab-02-Risk-Assessment-Workflow.md) · → [Next Lab](Lab-04-Non-Target-Data-Analysis.md)
> 📚 Related Module: [Module 6 — Gene Flow and Introgression](../MARKDOWN/06-Gene-Flow-and-Introgression.md) · 📊 Dataset: [Exercise 1 — Gene flow](../DATA/gene-flow/) · 📝 Assessment: [Data-Interpretation Questions](../ASSESSMENT/Data-Interpretation-Questions.md)
...
*Previous: [Lab 02 — Risk-Assessment Workflow](Lab-02-Risk-Assessment-Workflow.md) · Next: [Lab 04 — Non-Target Data Analysis](Lab-04-Non-Target-Data-Analysis.md)*
