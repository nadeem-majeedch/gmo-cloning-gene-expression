...
> **Navigation:** [↑ Course Home](../README.md) · ← [Previous Lab](Lab-04-Non-Target-Data-Analysis.md) · → [Next Lab](Lab-06-Environmental-Exposure-Analysis.md)
> 📚 Related Module: [Module 11 — Resistance Evolution](../MARKDOWN/11-Resistance-Evolution.md) · 📊 Dataset: [Exercise 3 — Resistance frequencies](../DATA/resistance/) · 📝 Assessment: [Data-Interpretation Questions](../ASSESSMENT/Data-Interpretation-Questions.md)
...
*Previous: [Lab 04 — Non-Target Data Analysis](Lab-04-Non-Target-Data-Analysis.md) · Next: [Lab 06 — Environmental Exposure Analysis](Lab-06-Environmental-Exposure-Analysis.md)*
