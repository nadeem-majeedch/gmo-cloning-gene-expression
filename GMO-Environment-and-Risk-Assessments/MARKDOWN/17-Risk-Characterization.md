...
> **Navigation:** [↑ Course Home](../README.md) · ← [Previous Topic](16-Unintended-Effects-and-Uncertainty.md) · → [Next Topic](18-Risk-Management.md)
> 🧪 Related Practicals: [Lab 09](../LAB/Lab-09-Risk-Ranking-Matrix.md) · [Lab 10](../LAB/Lab-10-Uncertainty-Sensitivity-Analysis.md) · 📊 Data: [Risk matrix](../DATA/risk-matrix/) · [Sensitivity runs](../DATA/uncertainty/) · 📝 Assessment: [MCQs](../ASSESSMENT/MCQs.md) · 📌 [Cheat Sheet](../CHEAT-SHEET/GMO-Environment-Risk-Assessment-Cheat-Sheet.md) · ❓ [FAQ](../FAQ/GMO-Environment-Risk-Assessment-FAQs.md)
...
**Matrix banding (5×5):** likelihood (rare → almost certain) × consequence (negligible → severe) → risk score 1–25, banded Low/Medium/High/Very-high ([DATA/risk-matrix](../DATA/risk-matrix/), Lab 09). Strengths: transparent, communicable, decision-ready. Limits: **bands are conventions, not measurements** — a 4→5 likelihood jump can move two bands; scoring rationale must accompany every score; sensitivity checks are mandatory (Exercise 10).
...
**Probabilistic characterization:** propagate input *distributions* (Monte Carlo, as in [DATA/uncertainty](../DATA/uncertainty/)) → output distribution → "P(RQ>1) = x%" style statements. Strength: variance becomes visible; the 95th percentile has meaning. Limits: demands distribution data that ecology rarely has; models become the risk (model uncertainty, Module 16 §16.4).
...
|---|---|---|
| Hazard threshold | [DATA/dose-response](../DATA/dose-response/) | IC50 ≈ 42 ng/cm² (sensitive-species proxy) |
| Exposure: pollen deposit on adjacent flora | [DATA/exposure](../DATA/exposure/) + deposition model | ≪ 1 ng/cm² realistic; bounding ≈ few ng/cm² |
...
*Next: [Module 18 — Risk Management](18-Risk-Management.md): what to do about characterized risks.*
