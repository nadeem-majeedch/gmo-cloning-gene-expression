...
> **Navigation:** [↑ Course Home](../README.md) · ← [Previous Topic](10-Biodiversity-and-Food-Webs.md) · → [Next Topic](12-Herbicide-Resistance-and-Weed-Management.md)
> 🧪 Related Practicals: [Lab 05](../LAB/Lab-05-Resistance-Evolution-Simulation.md) · [Lab 02](../LAB/Lab-02-Risk-Assessment-Workflow.md) · 📊 Data: [Bt resistance frequency](../DATA/resistance/) · 📝 Assessment: [MCQs](../ASSESSMENT/MCQs.md) · 📌 [Cheat Sheet](../CHEAT-SHEET/GMO-Environment-Risk-Assessment-Cheat-Sheet.md) · ❓ [FAQ](../FAQ/GMO-Environment-Risk-Assessment-FAQs.md)
...
- **No/unenforced refuges** → selection runs unopposed ([DATA/resistance](../DATA/resistance/) Exercise 3 shows the simulated divergence).
...
*(Detailed case treatments in [Module 23](23-Case-Studies.md), Cases 5–6; [FAQ - resistance].)*
...
From [DATA/resistance/bt_resistance_frequency.csv](../DATA/resistance/bt_resistance_frequency.csv) (simulated high-dose/refuge model):
...
*Next: [Module 12 — Herbicide Resistance and Weed Management](12-Herbicide-Resistance-and-Weed-Management.md): the same evolution, one trophic level up.*
