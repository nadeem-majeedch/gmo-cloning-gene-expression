...
> **Navigation:** [↑ Course Home](../README.md) · ← [Previous Topic](11-Resistance-Evolution.md) · → [Next Topic](13-Environmental-Fate-and-Exposure.md)
> 🧪 Related Practicals: [Lab 05](../LAB/Lab-05-Resistance-Evolution-Simulation.md) · [Lab 09](../LAB/Lab-09-Risk-Ranking-Matrix.md) · 📊 Data: [Herbicide-resistant weeds](../DATA/resistance/) · [Risk matrix](../DATA/risk-matrix/) · 📝 Assessment: [MCQs](../ASSESSMENT/MCQs.md) · 📌 [Cheat Sheet](../CHEAT-SHEET/GMO-Environment-Risk-Assessment-Cheat-Sheet.md) · ❓ [FAQ](../FAQ/GMO-Environment-Risk-Assessment-FAQs.md)
...
Result: resistance emergence follows an accelerating curve ([DATA/resistance](../DATA/resistance/), Exercise 4: continuous-glyphosate patches rise ~10 → ~21/season; rotated systems stay ~1).
...
[DATA/resistance/herbicide_resistant_weeds.csv](../DATA/resistance/herbicide_resistant_weeds.csv) (simulated, 14 seasons × 2 systems × 120 fields):
...
*Next: [Module 13 — Environmental Fate and Exposure](13-Environmental-Fate-and-Exposure.md): quantifying who meets what, where, and for how long.*
