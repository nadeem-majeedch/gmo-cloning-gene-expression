...
> **Navigation:** [↑ Course Home](../README.md) · ← [Previous Topic](17-Risk-Characterization.md) · → [Next Topic](19-Environmental-Monitoring.md)
> 🧪 Related Practicals: [Lab 09](../LAB/Lab-09-Risk-Ranking-Matrix.md) · [Lab 11](../LAB/Lab-11-Case-Study-Regulatory-Assessment.md) · 📊 Data: [Risk matrix](../DATA/risk-matrix/) · 📝 Assessment: [MCQs](../ASSESSMENT/MCQs.md) · 📌 [Cheat Sheet](../CHEAT-SHEET/GMO-Environment-Risk-Assessment-Cheat-Sheet.md) · ❓ [FAQ](../FAQ/GMO-Environment-Risk-Assessment-FAQs.md)
...
The simulated risk matrix ([DATA/risk-matrix](../DATA/risk-matrix/)) makes the point structurally:
...
*Next: [Module 19 — Environmental Monitoring](19-Environmental-Monitoring.md): the data system that keeps the license honest.*
