...
> **Navigation:** [↑ Course Home](../README.md) · ← *(start of course)* · → [Next Topic](02-Hazard-Risk-and-Exposure.md)
> 🧪 Related Practical: [Lab 01](../LAB/Lab-01-Terminology-and-Hazard-Identification.md) · 📊 Data: [Risk-matrix scores](../DATA/risk-matrix/) · 📝 Assessment: [MCQs](../ASSESSMENT/MCQs.md) · 📌 [Cheat Sheet](../CHEAT-SHEET/GMO-Environment-Risk-Assessment-Cheat-Sheet.md) · ❓ [FAQ](../FAQ/GMO-Environment-Risk-Assessment-FAQs.md)
...
*Figure references: hazard-vs-risk and framework diagrams in [DIAGRAMS](../DIAGRAMS/README.md); the framework workflow appears in Module 3.*
