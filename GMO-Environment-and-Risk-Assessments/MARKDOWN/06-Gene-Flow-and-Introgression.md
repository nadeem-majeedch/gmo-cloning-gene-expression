...
> **Navigation:** [↑ Course Home](../README.md) · ← [Previous Topic](05-Phenotypic-and-Compositional-Assessment.md) · → [Next Topic](07-Persistence-Weediness-and-Invasiveness.md)
> 🧪 Related Practicals: [Lab 03](../LAB/Lab-03-Gene-Flow-Data-Analysis.md) · [Lab 02](../LAB/Lab-02-Risk-Assessment-Workflow.md) · 📊 Data: [Gene flow](../DATA/gene-flow/) · 📝 Assessment: [MCQs](../ASSESSMENT/MCQs.md) · 📌 [Cheat Sheet](../CHEAT-SHEET/GMO-Environment-Risk-Assessment-Cheat-Sheet.md) · ❓ [FAQ](../FAQ/GMO-Environment-Risk-Assessment-FAQs.md)
...
Field studies (like the simulated one in [DATA/gene-flow](../DATA/gene-flow/), Lab 03) typically screen thousands to tens of thousands of offspring at a series of distances from a pollen source, yielding frequency-vs-distance curves:
...
From the simulated pollen-flow study ([DATA/gene-flow/pollen_flow_distance.csv](../DATA/gene-flow/pollen_flow_distance.csv); 8 distances × 5 replicates × ~40,000 seeds screened):
...
*Next: [Module 7 — Persistence, Weediness and Invasiveness](07-Persistence-Weediness-and-Invasiveness.md): what happens to the GM plant itself beyond the field.*
