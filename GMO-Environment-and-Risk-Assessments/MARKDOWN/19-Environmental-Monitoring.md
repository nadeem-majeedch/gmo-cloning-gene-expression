...
> **Navigation:** [↑ Course Home](../README.md) · ← [Previous Topic](18-Risk-Management.md) · → [Next Topic](20-Post-Market-and-Post-Release-Monitoring.md)
> 🧪 Related Practicals: [Lab 06](../LAB/Lab-06-Environmental-Exposure-Analysis.md) · [Lab 04](../LAB/Lab-04-Non-Target-Data-Analysis.md) · 📊 Data: [Exposure](../DATA/exposure/) · [Non-target](../DATA/non-target/) · 📝 Assessment: [MCQs](../ASSESSMENT/MCQs.md) · 📌 [Cheat Sheet](../CHEAT-SHEET/GMO-Environment-Risk-Assessment-Cheat-Sheet.md) · ❓ [FAQ](../FAQ/GMO-Environment-Risk-Assessment-FAQs.md)
...
Exposure-decay monitoring ([DATA/exposure](../DATA/exposure/)): if the assessment assumed debris half-life ~35 days, monitoring samples debris monthly and flags model exceedance if measured half-life > ~50 days (bounding-range trigger). Resistance monitoring ([DATA/resistance](../DATA/resistance/)): the gen-14 crossing of 1% in the no-refuge simulation is precisely the event the trigger architecture exists to catch — while there is still management time.
...
*Next: [Module 20 — Post-Market and Post-Release Monitoring](20-Post-Market-and-Post-Release-Monitoring.md): the regulatory machinery around long-term monitoring.*
