...
> **Navigation:** [↑ Course Home](../README.md) · ← [Previous Topic](07-Persistence-Weediness-and-Invasiveness.md) · → [Next Topic](09-Soil-Ecosystems-and-Microbial-Interactions.md)
> 🧪 Related Practicals: [Lab 04](../LAB/Lab-04-Non-Target-Data-Analysis.md) · [Lab 08](../LAB/Lab-08-Dose-Response-Analysis.md) · 📊 Data: [Non-target survival](../DATA/non-target/) · [Dose-response](../DATA/dose-response/) · 📝 Assessment: [MCQs](../ASSESSMENT/MCQs.md) · 📌 [Cheat Sheet](../CHEAT-SHEET/GMO-Environment-Risk-Assessment-Cheat-Sheet.md) · ❓ [FAQ](../FAQ/GMO-Environment-Risk-Assessment-FAQs.md)
...
From [DATA/non-target/nontarget_survival.csv](../DATA/non-target/nontarget_survival.csv) (simulated; 5 species × 2 treatments × replicates):
...
*Next: [Module 9 — Soil Ecosystems and Microbial Interactions](09-Soil-Ecosystems-and-Microbial-Interactions.md): below-ground ecology and the hardest detection problems.*
