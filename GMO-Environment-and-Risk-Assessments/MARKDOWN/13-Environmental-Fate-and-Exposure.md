...
> **Navigation:** [↑ Course Home](../README.md) · ← [Previous Topic](12-Herbicide-Resistance-and-Weed-Management.md) · → [Next Topic](14-Food-and-Feed-Safety.md)
> 🧪 Related Practicals: [Lab 06](../LAB/Lab-06-Environmental-Exposure-Analysis.md) · [Lab 08](../LAB/Lab-08-Dose-Response-Analysis.md) · 📊 Data: [Environmental concentrations](../DATA/exposure/) · 📝 Assessment: [MCQs](../ASSESSMENT/MCQs.md) · 📌 [Cheat Sheet](../CHEAT-SHEET/GMO-Environment-Risk-Assessment-Cheat-Sheet.md) · ❓ [FAQ](../FAQ/GMO-Environment-Risk-Assessment-FAQs.md)
...
From the simulated season dataset ([DATA/exposure](../DATA/exposure/)):
...
*Next: [Module 14 — Food and Feed Safety](14-Food-and-Feed-Safety.md): the human/animal endpoint of the assessment chain.*
