...
> **Navigation:** [↑ Course Home](../README.md) · [Workbook](../WORKBOOK/GMO-Cloning-Gene-Expression-Lab-Workbook.md) · 📊 [Spatial data](../DATA/spatial-expression-data/) · 📝 [Assessment](../ASSESSMENT/MCQs.md)
...
- Scoring keys and profile analysis are in the [Workbook](../WORKBOOK/GMO-Cloning-Gene-Expression-Lab-Workbook.md).
