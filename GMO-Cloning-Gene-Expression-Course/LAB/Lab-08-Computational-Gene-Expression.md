...
> **Navigation:** [↑ Course Home](../README.md) · [Workbook](../WORKBOOK/GMO-Cloning-Gene-Expression-Lab-Workbook.md) · 📊 [Gene-expression data](../DATA/gene-expression-data/) · [Spatial data](../DATA/spatial-expression-data/) · 📝 [Assessment](../ASSESSMENT/MCQs.md)
...
- Starter script + keys: `analysis_demo.py`; full solutions in the [Workbook](../WORKBOOK/GMO-Cloning-Gene-Expression-Lab-Workbook.md).
