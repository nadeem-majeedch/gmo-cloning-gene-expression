...
> **Navigation:** [↑ Course Home](../README.md) · ← [Previous Topic](14-Ethics-Biosafety-and-Regulation.md) · → *(end of course — see [README](../README.md) for review materials)*
> 🧪 Related Lab: [Lab 08](../LAB/Lab-08-Computational-Gene-Expression.md) · [Lab 09 — Capstone](../LAB/Lab-09-Capstone-Project.md) · 📊 Data: [single-cell](../DATA/gene-expression-data/) · [spatial](../DATA/spatial-expression-data/) · 📝 [Assessment](../ASSESSMENT/MCQs.md) · 📌 [Cheat Sheet](../CHEAT-SHEET/GMO-Cloning-Gene-Expression-Cheat-Sheet.md) · ❓ [FAQ](../FAQ/GMO-Cloning-Gene-Expression-FAQs.md)
...
> **Navigation:** [↑ Course Home](../README.md) · ← [Previous Topic](14-Ethics-Biosafety-and-Regulation.md) · → *(course complete — proceed to [Assessment](../ASSESSMENT/MCQs.md) and [Capstone Lab](../LAB/Lab-09-Capstone-Project.md))*
