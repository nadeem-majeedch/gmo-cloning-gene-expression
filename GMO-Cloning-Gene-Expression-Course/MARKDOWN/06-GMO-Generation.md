...
> **Navigation:** [↑ Course Home](../README.md) · ← [Previous Topic](05-Expression-Constructs-and-Reporter-Genes.md) · → [Next Topic](07-Genome-Editing-and-CRISPR.md)
> 🧪 Related Labs: [Lab 09 — Capstone Project](../LAB/Lab-09-Capstone-Project.md) · 📊 Data: [Cloning data](../DATA/cloning-data/) · 📝 [Assessment](../ASSESSMENT/MCQs.md) · 📌 [Cheat Sheet](../CHEAT-SHEET/GMO-Cloning-Gene-Expression-Cheat-Sheet.md) · ❓ [FAQ](../FAQ/GMO-Cloning-Gene-Expression-FAQs.md)
