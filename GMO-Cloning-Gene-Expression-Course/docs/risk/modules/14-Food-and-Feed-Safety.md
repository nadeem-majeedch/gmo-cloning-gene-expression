...
From [DATA/composition](../downloads/composition.md) (simulated 3 sites × 6 reps): all 10 analytes within reference envelopes; GM-vs-control differences ≤ ~4% and patternless (Lab 07). The instructive point is *how* the equivalence conclusion is earned: envelope logic, multiple-comparison awareness, and effect-size language — not the absence of p-values.
...
*Next: [Module 15 — Allergenicity and Toxicity Assessment](../../risk/modules/15-Allergenicity-and-Toxicity-Assessment.md): the two protein-safety sciences in detail.*---
...
[<- Environmental Fate and Exposure](../modules/13-Environmental-Fate-and-Exposure.md) &middot; [Course home](../index.md) &middot; [Continue to next module ->](../modules/15-Allergenicity-and-Toxicity-Assessment.md)
