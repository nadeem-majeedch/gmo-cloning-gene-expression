...
*Next: [Module 17 — Risk Characterization](../../risk/modules/17-Risk-Characterization.md): integrating everything into conclusions.*---
...
[<- Allergenicity and Toxicity Assessment](../modules/15-Allergenicity-and-Toxicity-Assessment.md) &middot; [Course home](../index.md) &middot; [Continue to next module ->](../modules/17-Risk-Characterization.md)
