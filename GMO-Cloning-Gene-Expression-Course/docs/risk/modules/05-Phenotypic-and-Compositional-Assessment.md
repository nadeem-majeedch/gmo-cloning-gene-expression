...
Working from the simulated dataset ([DATA/composition](../downloads/composition.md), Lab 07):
...
From [DATA/composition/compositional_analysis.csv](../../assets/risk/DATA/composition/compositional_analysis.csv) (simulated; 3 sites × 6 reps × 10 analytes):
...
*Next: [Module 6 — Gene Flow and Introgression](../../risk/modules/06-Gene-Flow-and-Introgression.md): the movement of traits beyond their target fields.*---
...
[<- Molecular Characterization](../modules/04-Molecular-Characterization.md) &middot; [Course home](../index.md) &middot; [Continue to next module ->](../modules/06-Gene-Flow-and-Introgression.md)
