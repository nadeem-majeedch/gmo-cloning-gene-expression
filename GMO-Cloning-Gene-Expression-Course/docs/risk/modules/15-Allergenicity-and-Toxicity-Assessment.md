...
<figure markdown>
![The weight-of-evidence allergenicity assessment: no single test is decisive.](../../assets/risk/DIAGRAMS/18-allergenicity-woe.png)

*Figure - The weight-of-evidence allergenicity assessment: no single test is decisive.*
</figure>


## Example data (dose-response teaching fit)

[DATA/dose-response/dose_response_larvae.csv](../../assets/risk/DATA/dose-response/dose_response_larvae.csv): 7 doses × 8 reps × 12 larvae; hill fit → IC50 ≈ 42 ng/cm², slope ≈ 1.6; zero-dose control anchors the top plateau. Interpretation discipline: the *hazard* is characterized; *risk* requires placing real environmental/dietary exposures against this curve (Module 13).
...
*Next: [Module 16 — Unintended Effects and Uncertainty](../../risk/modules/16-Unintended-Effects-and-Uncertainty.md): what happens when the picture is incomplete.*---
...
[<- Food and Feed Safety](../modules/14-Food-and-Feed-Safety.md) &middot; [Course home](../index.md) &middot; [Continue to next module ->](../modules/16-Unintended-Effects-and-Uncertainty.md)
