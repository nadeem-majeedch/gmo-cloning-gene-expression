...
- **Proteins:** adsorb to clay/humic particles, which can *protect* them from microbial degradation; active fraction typically declines over weeks–months (the exposure dataset's rhizosphere-soil decay curve, [DATA/exposure](../downloads/exposure.md), models this). Detection can outlast activity — measurement ≠ biological effect.
...
[DATA/soil/soil_otu_counts.csv](../../assets/risk/DATA/soil/soil_otu_counts.csv) simulates a 40-OTU subset × 2 treatments × 3 stages × 6 plots. Lab 06's analysis shows:
...
*Next: [Module 10 — Biodiversity and Food Webs](../../risk/modules/10-Biodiversity-and-Food-Webs.md): scaling from species tests to community and ecosystem questions.*---
...
[<- Non-Target Organisms](../modules/08-Non-Target-Organisms.md) &middot; [Course home](../index.md) &middot; [Continue to next module ->](../modules/10-Biodiversity-and-Food-Webs.md)
