...
*Next: [Module 5 — Phenotypic and Compositional Assessment](../../risk/modules/05-Phenotypic-and-Compositional-Assessment.md): from molecules to the organism-level evidence.*---
...
[<- The GMO Environmental Risk-Assessment Framework](../modules/03-GMO-Environmental-Risk-Assessment-Framework.md) &middot; [Course home](../index.md) &middot; [Continue to next module ->](../modules/05-Phenotypic-and-Compositional-Assessment.md)
