...
<figure markdown>
![Food-web routes by which trait effects propagate indirectly through communities.](../../assets/risk/DIAGRAMS/10-food-web.png)

*Figure - Food-web routes by which trait effects propagate indirectly through communities.*
</figure>
...
*Next: [Module 11 — Resistance Evolution](../../risk/modules/11-Resistance-Evolution.md): the evolutionary dynamic that has defined GMO risk management in practice.*---
...
[<- Soil Ecosystems and Microbial Interactions](../modules/09-Soil-Ecosystems-and-Microbial-Interactions.md) &middot; [Course home](../index.md) &middot; [Continue to next module ->](../modules/11-Resistance-Evolution.md)
