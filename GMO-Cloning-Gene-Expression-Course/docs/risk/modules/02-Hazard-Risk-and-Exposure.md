...
- **Sigmoid (hill) curves** — typical of many toxicological and protein-mediated effects: minimal response at low dose, steep transition around an IC50/EC50 (see [Lab 08](../../risk/labs/Lab-08-Dose-Response-Analysis.md), Exercise 8).
...
Using the simulated risk-matrix dataset ([DATA/risk-matrix](../downloads/risk-matrix.md)):
...
<figure markdown>
![Hazard versus risk: exposure, dose-response and context convert a hazard into a characterized risk.](../../assets/risk/DIAGRAMS/01-hazard-vs-risk.png)

*Figure - Hazard versus risk: exposure, dose-response and context convert a hazard into a characterized risk.*
</figure>

<figure markdown>
![The interpretive chain from observed difference to characterized risk.](../../assets/risk/DIAGRAMS/17-difference-vs-harm.png)

*Figure - The interpretive chain from observed difference to characterized risk.*
</figure>
...
*Next: [Module 3 — The GMO Environmental Risk-Assessment Framework](../../risk/modules/03-GMO-Environmental-Risk-Assessment-Framework.md) formalizes these concepts into the standard workflow.*---
...
[<- Introduction to GMO Risk Assessment](../modules/01-Introduction-to-GMO-Risk-Assessment.md) &middot; [Course home](../index.md) &middot; [Continue to next module ->](../modules/03-GMO-Environmental-Risk-Assessment-Framework.md)
