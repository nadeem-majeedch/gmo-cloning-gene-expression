...
*Previous: [Data Analysis](../../risk/modules/24-Data-Analysis.md) · Next: [Assessment Package](../../risk/assessment/MCQs.md)*---
...
[<- Data Analysis for GMO Risk Assessment](../modules/24-Data-Analysis.md) &middot; [Course home](../index.md)
