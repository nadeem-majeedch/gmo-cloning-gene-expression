...
*Instructor: Dr. Saira Azam, CEMB, University of the Punjab, Lahore. Datasets: [DATA/](../downloads/datasets.md); answers reproducible via `DATA/analysis_demo.py`.*
...
*Datasets: [DATA/README](../../risk/index.md) · Related labs: [Lab 03](../../risk/labs/Lab-03-Gene-Flow-Data-Analysis.md)–[Lab 10](../../risk/labs/Lab-10-Uncertainty-Sensitivity-Analysis.md) · [Answer-Key](../../risk/assessment/Answer-Key.md)*
