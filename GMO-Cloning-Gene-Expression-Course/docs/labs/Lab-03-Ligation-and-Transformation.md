...
- Expected pattern: L1 < L3 < L2 in correct-clone rate; L4 shows concatemers. Colony counts are in the CSV; class-average discussion points are in the [Workbook](../guide/workbook.md).
