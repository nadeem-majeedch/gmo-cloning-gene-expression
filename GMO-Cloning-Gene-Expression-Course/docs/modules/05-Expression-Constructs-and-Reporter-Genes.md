...
*Figure - An expression cassette: promoter, translation-initiation context, open reading frame and terminator/polyadenylation signal.*
</figure>
...
[<- Cloning Techniques](../modules/04-Cloning-Techniques.md) &middot; [Course home](../index.md) &middot; [Continue to next module ->](../modules/06-GMO-Generation.md)
