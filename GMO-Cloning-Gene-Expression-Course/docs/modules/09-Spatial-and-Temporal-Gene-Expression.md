...
*Figure - A morphogen gradient patterned by production, diffusion and decay; threshold concentrations specify distinct cell fates.*
</figure>
...
*Figure - Spatial gene-expression domains in the vertebrate neural tube generated by opposing Shh and BMP gradients.*
</figure>
...
[<- Developmental Gene Expression](../modules/08-Developmental-Gene-Expression.md) &middot; [Course home](../index.md) &middot; [Continue to next module ->](../modules/10-Gene-Regulatory-Networks.md)
