...
Module 2 dissects the molecular substrate — DNA fragments, vectors and plasmid architecture — and walks the full molecular-cloning workflow stage by stage. Before that, skim the [Cheat Sheet](../guide/cheat-sheet.md) vocabulary section and try the [Lab 01 design exercise](../labs/Lab-01-DNA-Cloning-Design.md) if you already have basic molecular-biology background.
---
...
[Course home](../index.md) &middot; [Continue to next module ->](../modules/02-DNA-and-Molecular-Cloning.md)
