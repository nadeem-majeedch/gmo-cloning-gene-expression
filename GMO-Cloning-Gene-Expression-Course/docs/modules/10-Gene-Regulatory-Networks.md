...
[<- Spatial and Temporal Gene Expression](../modules/09-Spatial-and-Temporal-Gene-Expression.md) &middot; [Course home](../index.md) &middot; [Continue to next module ->](../modules/11-Gene-Expression-Experimental-Methods.md)
