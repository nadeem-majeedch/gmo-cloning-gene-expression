...
*Figure - RT-qPCR workflow from RNA isolation to the delta-delta-Ct relative-expression calculation.*
</figure>
...
[<- Gene Regulatory Networks](../modules/10-Gene-Regulatory-Networks.md) &middot; [Course home](../index.md) &middot; [Continue to next module ->](../modules/12-Data-Analysis.md)
